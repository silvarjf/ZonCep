...
#TODO:
#adicionar grupo na interface ----> beleza
#carregar tipo de solo do banco ----> nao encontrei os tipos de solo no banco
#carregar estados do banco ----> beleza

#outra interface:
#carregar nomes das pastas das culturas já simulados em combo box   /home/daniel/Desktop/tcc/novoSarra/simulacoes  ---> beleza
#a partir do nome da cultura, carregar estados simulados dessa cultura em outro combo box ---> beleza
#carregar dataframe dentro dessa pasta
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def simular(self):
        ...
        simulacao.simular(estado,inisim,dataplantio,tiposolo,idgrupo,estoqueini,chuvalimite,mulch,rusurf,resutil,escsup,anos)
